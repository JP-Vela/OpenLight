...
class OpenLight {
    ...
    constructor(changeType="auto"){
        ...
        if(changeType=="auto"){
            ...
            console.error("Change type not set correctly. Please use \"auto\" or \"manual\". Defaulting to auto");
        }
    ...
    lightModeManual(){
        ...
        for(var i = 0;i<backgroundElem.length;i++){
            ...
            if(backgroundElem[i].classList.contains(this.light)){  
                backgroundElem[i].style.backgroundColor=this.openLightColors.lightBackgroundStyle;
            } else {
                backgroundElem[i].style.backgroundColor=this.openLightColors.darkBackgroundStyle;
            }
        }
        ...
        for(var i = 0;i<foregroundElem.length;i++){
            ...
            if(foregroundElem[i].classList.contains(this.light)){
                foregroundElem[i].style.color=this.openLightColors.lightForegroundStyle;
            } else {
                foregroundElem[i].style.color=this.openLightColors.darkForegroundStyle;
            }
        }
